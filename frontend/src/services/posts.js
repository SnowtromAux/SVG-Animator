 ...
 */
const MY_POSTS_URL = `${API_BASE_URL}/posts/get-my-posts`;
const DELETE_POST_URL = `${API_BASE_URL}/posts/delete-post`;

// ✅ Reactions (like / dislike)
const LIKE_POST_URL = `${API_BASE_URL}/posts/like-post`;
const DISLIKE_POST_URL = `${API_BASE_URL}/posts/dislike-post`;
